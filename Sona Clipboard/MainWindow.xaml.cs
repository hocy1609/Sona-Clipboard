...
namespace Sona_Clipboard
{
    public sealed partial class MainWindow : Window
    {
        ...
        private void ApplyHotKeys_Click(object sender, RoutedEventArgs e) { HotKeyHelper.Unregister(_hWnd, ID_NEXT); HotKeyHelper.Unregister(_hWnd, ID_PREV); RegisterHotKeysFromUI(); SaveSettings(); MaintenanceStatus.Text = "Готово!"; }
